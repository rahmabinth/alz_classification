...
# Create a subset to contain the selected features and the target 
# variable for the training data
train_selected <- train_data[, c(selected_features, "Diagnosis")]
# Create a subset to contain the selected features and the Patient 
# ID for the test data
